...
public class UImanagement : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (SceneManager.GetActiveScene().name == "MainScene1")
        {
            Debug.Log("今のベストスコア取得");
            ReBestScoreText.text = "Best Score : " + bestScore1.ToString();
            if (bestScore1 < score)
            {
        ...
        if (SceneManager.GetActiveScene().name == "MainScene2")
        {
            ReBestScoreText.text = "Best Score : " + bestScore2.ToString();
            if (bestScore2 < score)
            {
        ...
        if (SceneManager.GetActiveScene().name == "MainScene3")
        {
            ReBestScoreText.text = "Best Score : " + bestScore3.ToString();
            if (bestScore3 < score)
            {
        ...
        if (SceneManager.GetActiveScene().name == "MainScene4")
        {
            ReBestScoreText.text = "Best Score : " + bestScore4.ToString();
            if (bestScore4 < score)
            {
        ...
        if (SceneManager.GetActiveScene().name == "MainScene5")
        {
            ReBestScoreText.text = "Best Score : " + bestScore5.ToString();
            if (bestScore5 < score)
            {
